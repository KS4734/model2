...
// 캡슐화(디자인 패턴) : 접근지정지와 get set 함수를 정의해 접근의 제어하는 것 (vo, dto) 
	private String userId;
	// db가 대소문자를 구분하지 않는 경우 언더바 표기법을 사용하는데 자바의 변수 규칙은 낙타표기법이라 lib 적용시 문제가 생길 수 있다.
	private String name;
	private String pw;
	...
	public String toString() {
		return "\"emp\":{ \"userId\":\"" + userId + "\",\"name\":\"" + name + "\",\"pw\":\"" + pw + "\",\"phone\":\""
