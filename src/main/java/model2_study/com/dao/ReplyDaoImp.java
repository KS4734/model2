...
public class ReplyDaoImp implements ReplyDao{
	...
	private String listFindByBoardNoSql="SELECT * FROM REPLY WHERE board_no=? ORDER BY reply_no DESC LIMIT ?,?";
	private String insertSql="INSERT INTO REPLY (board_no,title,contents,user_id,img_path) VALUES (?,?,?,?,?)";
	...
	public ReplyDaoImp(Connection conn) throws Exception {
		this.conn=conn;
	}
	@Override
	...
	@Override
	public List<ReplyDto> listFindByUserId(int page, String userId) {
		return null;
	}
