...
public class BoardDetailServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String forwardPage="./boardDetail.jsp";
		...
		try {
			...
			if(loginUser_obj!=null) {
				...
				BoardPreferDto boardPrefer = boardPreferDao.detailFindbyUserIdAndBoardNo(loginUser.getUserId(), boardNo);
				if(boardPrefer!=null) {
			...
			if(replyDao!=null)boardDao.close();
